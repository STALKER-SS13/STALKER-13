...
#define LIGHTING_PLANE_ALPHA_VISIBLE 1//255
#define LIGHTING_PLANE_ALPHA_NV_TRAIT 0//245
#define LIGHTING_PLANE_ALPHA_MOSTLY_VISIBLE 0//192
#define LIGHTING_PLANE_ALPHA_MOSTLY_INVISIBLE 1//128 //For lighting alpha, small amounts lead to big changes. even at 128 its hard to figure out what is dark and what is light, at 64 you almost can't even tell.
#define LIGHTING_PLANE_ALPHA_INVISIBLE 0//0
