...
/obj/screen/plane_master/openspace/backdrop(mob/mymob)
	filters = list()
	filters += filter(type = "drop_shadow", color = "#04080FAA", offset = 5, size = -10)
	filters += filter(type = "drop_shadow", color = "#04080FAA", offset = 5, size = -15)
	filters += filter(type = "drop_shadow", color = "#04080FAA", offset = 5, size = -20)
