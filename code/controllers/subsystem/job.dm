...
/datum/controller/subsystem/job/proc/EquipRank(mob/M, rank, joined_late = FALSE)
	...
	if(job)
		...
		to_chat(M, "<FONT color='red'><b><h1>SOS disclaimer: DO NOT SALT IN DEAD CHAT OR DISCORD ABOUT LOSING. WHEN YOU DECIDE TO JOIN DUTY/FREEDOM OR CLEARSKY/RENEGADES, YOU ACCEPT THE FACT THAT YOUR CHARACTER MAY BE GANKED, MAY BE SHOT FROM OFF SCREEN OR IN THE DARK, AND MAY BE MURDERED IN SOME CAPACITY YOU DEEM UNFAIR. DO NOT COMPLAIN ABOUT IT, DO NOT TAKE IT PERSONALLY AND MAKE IT AN OOC ISSUE IN ANY WAY. THERE IS ALWAYS A NEXT ROUND. IF YOU ARE FOUND TO BE META-TARGETING, META-GRUDGING, OR IN ANY WAY CAUSING OOC DRAMA OR ISSUES AS A RESULT OF THIS, YOU WILL BE JOB BANNED FROM ALL SHOOT ON SIGHT FACTIONS. TL;DR: DO NOT BE SASSY ABOUT DYING OR YOU'RE UNROBUST.</h1></b>")
