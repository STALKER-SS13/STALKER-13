...
/datum/controller/subsystem/job/proc/EquipRank(mob/M, rank, joined_late = FALSE)
	...
	if(job)
		...
		to_chat(M, "<FONT color='red'><b><h2>Shoot On Sight disclaimer: DO NOT SALT IN DEAD CHAT, OOC, OR DISCORD ABOUT DYING. FREEDOM MAY SHOOT DUTY ON SITE, AND RENEGADES MAY SHOOT CLEAR SKY ON SHOT, AND VICE VERSA. ALL OTHER COMBAT MUST BE INITIATED WITH ESCALATION, 'I'm going to shoot you now' or emoting taking your gun out and shooting. DO NOT SALT OOCLY IN DISCORD/DEADCHAT/ELSEWHERE ABOUT DEATH. JOINING AN SOS FACTION YOU ACCEPT YOU MAY BE SHOT OFF SCREEN, IN THE DARK, OR IN A WAY YOU DO NOT LIKE. <FONT color='red'>TL;DR: DO NOT GET SASSY ABOUT DEATH, THERE IS ANOTHER ROUND AFTER THIS ONE, ITS JUST A GAME.</h2></b>")
