...
/obj/item/storage/backpack/satchel/stalker/civilian/provision
	desc = "A small satchel containing an assortment of various medicines, food, crucial equipment and basic ammunition."

/obj/item/storage/backpack/satchel/stalker/civilian/provision/PopulateContents()
	new /obj/item/reagent_containers/food/snacks/stalker/konserva(src)
	new /obj/item/reagent_containers/food/snacks/stalker/konserva(src)
	new /obj/item/reagent_containers/food/snacks/stalker/konserva(src)
	new /obj/item/reagent_containers/food/snacks/stalker/konserva(src)
	new /obj/item/reagent_containers/food/snacks/stalker/konserva/shproti(src)
	new /obj/item/reagent_containers/food/snacks/stalker/konserva/soup(src)
	new /obj/item/reagent_containers/food/snacks/stalker/konserva/bobi(src)
	new /obj/item/reagent_containers/food/snacks/stalker/kolbasa(src)
	new /obj/item/reagent_containers/food/snacks/stalker/kolbasa(src)
	new /obj/item/reagent_containers/food/snacks/stalker/kolbasa(src)
	new /obj/item/reagent_containers/food/snacks/stalker/kolbasa(src)
	new /obj/item/reagent_containers/food/snacks/stalker/kolbasa(src)
	new /obj/item/reagent_containers/food/snacks/stalker/kolbasa(src)
	new /obj/item/reagent_containers/food/snacks/stalker/baton(src)
	new /obj/item/reagent_containers/food/snacks/stalker/baton(src)
	new /obj/item/reagent_containers/food/snacks/stalker/baton(src)
	new /obj/item/reagent_containers/food/snacks/stalker/baton(src)
	new /obj/item/reagent_containers/food/snacks/stalker/baton(src)
	new /obj/item/reagent_containers/food/snacks/stalker/baton(src)
	new /obj/item/storage/firstaid/stalker/civillian(src)
	new /obj/item/storage/firstaid/stalker/civillian(src)
	new /obj/item/storage/firstaid/stalker/civillian(src)
	new /obj/item/storage/firstaid/stalker/civillian(src)
	new /obj/item/storage/firstaid/stalker/civillian(src)
	new /obj/item/storage/firstaid/stalker/civillian(src)
	new /obj/item/storage/firstaid/stalker/civillian(src)
	new /obj/item/storage/firstaid/stalker/military(src)
	new /obj/item/reagent_containers/pill/stalker/injector/antirad(src)
	new /obj/item/reagent_containers/pill/stalker/injector/antirad(src)
	new /obj/item/reagent_containers/pill/stalker/injector/antirad(src)
	new /obj/item/reagent_containers/pill/stalker/injector/antirad(src)
...
/obj/item/storage/backpack/satchel/stalker/civilian/basic_guns
	desc = "A small satchel containing some cheap weaponry."

/obj/item/storage/backpack/satchel/stalker/civilian/basic_guns/PopulateContents()
	new /obj/item/gun/ballistic/automatic/pistol/pm(src)
	new /obj/item/gun/ballistic/automatic/pistol/pm(src)
	new /obj/item/gun/ballistic/automatic/pistol/pm(src)
	new /obj/item/gun/ballistic/automatic/pistol/fort12(src)
	new /obj/item/gun/ballistic/automatic/pistol/pb1s(src)
	new /obj/item/gun/ballistic/shotgun/bm16(src)
	new /obj/item/gun/ballistic/shotgun/bm16/sawnoff(src)
	new /obj/item/gun/ballistic/shotgun/bm16/sawnoff(src)
	new /obj/item/gun/ballistic/shotgun/ithaca(src)
	new /obj/item/gun/ballistic/automatic/kiparis(src)
	new /obj/item/gun/ballistic/automatic/kiparis(src)

/obj/item/storage/backpack/satchel/stalker/civilian/basic_armor
	desc = "A small satchel containing some cheap PPE."

/obj/item/storage/backpack/satchel/stalker/civilian/basic_armor/PopulateContents()
	new /obj/item/clothing/suit/hooded/kozhanka/banditka/unique(src)
	new /obj/item/clothing/suit/hooded/kozhanka/unique(src)
	new /obj/item/clothing/suit/hooded/kombez(src)
	new /obj/item/clothing/suit/hooded/kombez(src)
	new /obj/item/clothing/suit/army(src)
	new /obj/item/clothing/suit/sixb2(src)
	new /obj/item/clothing/head/steel(src)
	new /obj/item/clothing/head/steel(src)
	new /obj/item/clothing/mask/gas/stalker/gp4(src)
	new /obj/item/clothing/mask/gas/stalker/gp5(src)
	new /obj/item/clothing/mask/gas/stalker/respirator(src)
	new /obj/item/clothing/mask/gas/stalker/mercenary(src)

/obj/item/storage/backpack/satchel/stalker/civilian/anomalous_trader
	desc = "A small satchel containing smuggled scientific equipment."

/obj/item/storage/backpack/satchel/stalker/civilian/anomalous_trader/PopulateContents()
	new /obj/item/detector/blink(src)
	new /obj/item/detector/blink(src)
	new /obj/item/detector/blink(src)
	new /obj/item/detector/bear(src)
	new /obj/item/detector/bear(src)
	new /obj/item/clothing/suit/hooded/sealed/ecolog(src)
