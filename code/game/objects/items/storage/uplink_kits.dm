...
/obj/item/storage/box/syndicate/bundle_A/PopulateContents()
	switch (pickweight(list("merc" = 2, "duty" = 2, "freedom" = 2, "monolith" = 1, "clear_sky" = 2, "loner" = 3, "military" = 2, "ecologist" = 1, "bandit" = 3)))
		if("merc") // 26 tc
		...
		if("duty") // 27 tc now this is more right
		...
		if("military") // 55+ tc holy shit what the fuck this is a lottery disguised as fun boxes isn't it?
