...
/obj/item/reagent_containers/food/snacks/salad/riceflesh
	name = "rice and flesh"
	desc = "Well, it looks edible..."
	icon_state = "riceporkbowl"
	bonus_reagents = list("nutriment" = 20, "vitamin" = 4, "omnizine" = 5)
	tastes = list("rice" = 1, "meat" = 1)
	foodtype = GRAIN | MEAT

/obj/item/reagent_containers/food/snacks/salad/riceboar
	name = "rice and boar"
	desc = "Well, it looks edible..."
	icon_state = "riceporkbowl"
	bonus_reagents = list("nutriment" = 20, "vitamin" = 4, "omnizine" = 5)
...
/obj/item/reagent_containers/food/snacks/salad/ricedog
...
/obj/item/reagent_containers/food/snacks/salad/ricepseudog
	name = "rice and pseudog"
	desc = "Well, it looks edible..."
	icon_state = "riceporkbowl"
	bonus_reagents = list("nutriment" = 20, "vitamin" = 4, "omnizine" = 5)
	tastes = list("rice" = 1, "meat" = 1)
...
/obj/item/reagent_containers/food/snacks/salad/ricesnork
	name = "rice and snork"
	desc = "Well, it looks edible..."
	icon_state = "riceporkbowl"
	bonus_reagents = list("nutriment" = 20, "vitamin" = 4, "omnizine" = 5)
...
/obj/item/reagent_containers/food/snacks/salad/ricebloodsucker
...
/obj/item/reagent_containers/food/snacks/salad/ricecontroller
...
/obj/item/reagent_containers/food/snacks/salad/ricerat
	name = "rice and rat"
	desc = "Well, it looks edible..."
	icon_state = "riceporkbowl"
	bonus_reagents = list("nutriment" = 20, "vitamin" = 4, "omnizine" = 5)
