...
/obj/item/seeds/ambrosia
	...
	reagents_add = list("lsd" = 0.15, "bicaridine" = 0.1, "kelotane" = 0.1, "vitamin" = 0.04, "nutriment" = 0.05, "toxin" = 0.1)
...
/obj/item/seeds/ambrosia/deus
	...
	reagents_add = list("omnizine" = 0.15, "synaptizine" = 0.15, "lsd" = 0.1, "vitamin" = 0.04, "nutriment" = 0.05)
	rarity = 40
