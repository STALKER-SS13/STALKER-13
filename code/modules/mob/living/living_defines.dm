/mob/living
	...
	var/rating_add = 0 // Number of rating exp we getting from butchering it
	...
	var/global_armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "psy" = 0)
