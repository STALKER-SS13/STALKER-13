...
//	product_ads = "Tested and proven by time to help humans overcome anything; Cigarettes. Smoke today, and smoke regularly!!;The cigarette is a versatile tool, and it's good for you!;The latest survey suggests that 7/10 stalkers who smoke survive engagement with psychological threats within the Zone! More information will come as updates arise.;Smoke!;Get a slice of nicotine heaven, no matter where you are in the world!;Most will disappoint, our cigarettes always deliver. Ditch uncertainty, and smoke today!.;Award-winning cigs, for award-winning stalkers!"
	...
	products = list(/obj/item/storage/fancy/cigarettes = 0,
					...
					/obj/item/storage/fancy/cigarettes/cigpack_midori = 0,
					/obj/item/storage/fancy/cigarettes/cigpack_laika = 0,
					/obj/item/storage/fancy/cigarettes/cigpack_marlborogold = 1,
					/obj/item/storage/fancy/cigarettes/cigpack_luckystrikesg = 0,
					/obj/item/storage/fancy/cigarettes/cigpack_luckystrikes = 0,
					/obj/item/storage/fancy/cigarettes/cigpack_newports = 0,
					/obj/item/storage/box/matches = 1,
					/obj/item/lighter/greyscale = 0,
...
/obj/machinery/vending/cigarette/beach //Used in the lavaland_biodome_beach.dmm ruin
	name = "\improper Special Cigarette Vendor Machine"
	desc = "Now with extra premium products!"
	product_slogans = "Dope will get you through times of no money better than money will get you through times of no dope!;Cigarettes taste good like a cigarette should.;I'd rather walk right into an anomaly than never toke again! ... Smoke!;Don't believe the reports - smoke today, and smoke regularly!"
	product_ads = "Turn on, tune in, drop out!;Toke!;Don't forget to keep a smile on your lips and a song in your heart!;Tested and proven by time to help humans overcome anything; Cigarettes. Smoke today, and smoke regularly!!;The cigarette is a versatile tool, and it's good for you!;The latest survey suggests that 7/10 stalkers who smoke survive engagement with psychological threats within the Zone! More information will come as updates arise.;Smoke!;Get a slice of nicotine heaven, no matter where you are in the world!;Most will disappoint, our cigarettes always deliver. Ditch uncertainty, and smoke today!.;Award-winning cigs, for award-winning stalkers!"
	icon_state = "cigs"
	products = list(/obj/item/storage/fancy/cigarettes = 3,
					...
					/obj/item/storage/fancy/cigarettes/cigpack_java = 3,
					/obj/item/storage/fancy/cigarettes/cigpack_luckystrikes = 2,
					/obj/item/storage/fancy/cigarettes/cigpack_midori = 1,
					/obj/item/storage/fancy/cigarettes/cigpack_laika = 2,
					/obj/item/storage/fancy/cigarettes/cigpack_cannabis = 1,
					/obj/item/storage/fancy/cigarettes/cigpack_luckystrikesg = 1,
					/obj/item/storage/fancy/cigarettes/cigpack_luckystrikes = 2,
...
/obj/machinery/vending/cigarette/vendor
	name = "\improper Cigarette Vendor Machine"
	...
	products = list(/obj/item/storage/fancy/cigarettes = 5,
					...
					/obj/item/storage/fancy/cigarettes/cigpack_luckystrikesg = 2,
					/obj/item/storage/fancy/cigarettes/cigpack_luckystrikes = 2,
					/obj/item/storage/fancy/cigarettes/cigpack_newports = 2,
					/obj/item/storage/box/matches = 5,
