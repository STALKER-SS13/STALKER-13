/obj/machinery/vending/cigarette
	...
	product_slogans = "Cigarettes taste good like a cigarette should.;I'd rather get a toolbox to the head than switch.;Smoke!;Don't believe the reports - smoke today!"
	product_ads = "Probably not bad for you!;Don't believe the scientists!;It's good for you!;Don't quit, buy more!;Smoke!;Nicotine heaven.;Best cigarettes since the beginning of time!.;Award-winning cigs."
	icon_state = "cigs"
