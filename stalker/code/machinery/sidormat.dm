...
GLOBAL_LIST_INIT(global_sidormat_list, list(
	...
	"Handguns" = list(
		...
		new /datum/data/stalker_equipment("MAC10 Ingram",   "MAC10 Ingram",     /obj/item/gun/ballistic/automatic/mac10,                    32000,  EXPERIENCED)
		),
	...
	"Ammo Magazines and Clips" = list(
		...
		new /datum/data/stalker_equipment("MAC10 Magazine",				        	"MAC10 Magazine",		        /obj/item/ammo_box/magazine/stalker/mac10,				4500,	EXPERIENCED,	sale_price =500),
