...
GLOBAL_LIST_INIT(global_sidormat_list, list(
	...
	"Suits" = list(
		...
		new	/datum/data/stalker_equipment("Bandit Exoskeleton",			"Bandit Exoskeleton",		/obj/item/clothing/suit/hooded/sealed/exoskelet/bandit,		400000,		EXPERT,	faction = "Bandits"),
