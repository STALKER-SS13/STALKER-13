...
/* Igiari's Old/Handmade Ammo - Casings

It's just the in-hand/in-gun item that calls the bullet.
Not sure what else to say. Again, no variants.

*/

/obj/item/ammo_casing/c9x18/hm
	desc = "A 9x18mm bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bullet9x18/hm
	icon_state = "shm-casing"

/obj/item/ammo_casing/c545/hm
	desc = "A 5.45x39mm bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bullet545/hm
	icon_state = "shm-casing"


/obj/item/ammo_casing/shotgun/c12x70/hm
	desc = "A 12x70mm bullet casing. The firing cap is tarnished and cheap, and the plastic is cracked."
	projectile_type = /obj/item/projectile/bullet/bullet12x70/hm
	icon_state = "gshellhm"


/obj/item/ammo_casing/c9x19/hm
	desc = "A 9x19mm bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bullet9x19/hm
	icon_state = "shm-casing"


/obj/item/ammo_casing/sp9x39/hm
	desc = "A 9x39mm bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bullet9x39/hm
	icon_state = "shm-casing"


/obj/item/ammo_casing/acp45/hm
	desc = "A .45 ACP bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bulletacp45/hm
	icon_state = "shm-casing"


/obj/item/ammo_casing/c556x45/hm
	desc = "A 5.55x45mm bullet. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bullet556x45/hm
	icon_state = "shm-casing"


/obj/item/ammo_casing/mag44/hm
	desc = "A .44 Magnum bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bulletmag44/hm
	icon_state = "shm-casing"


/obj/item/ammo_casing/c762x25/hm
	desc = "A 7.62x25 bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bullet762x25/hm
	icon_state = "762hm-casing"


/obj/item/ammo_casing/c762x54/hm
	desc = "A 7.62x54 bullet casing. The casing is tarnished and cheap."
	projectile_type = /obj/item/projectile/bullet/bullet762x54/hm
	icon_state = "762hm-casing"
