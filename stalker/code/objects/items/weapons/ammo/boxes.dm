...
/* Igiari's Old/Handmade Ammo - Ammo Boxes

Just boxes that hold the ammo. They have a silver band
around them (duct-tape) to signify that they're the worse
kind of bullets to use. No variants, only base bullet.

*/

/obj/item/ammo_box/stalker/b545/hm
	desc = "Standard issue intermediate cartridge of Warsaw Pact countries, Full Metal Jacket, (5.45x39mm 7N6). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/c545/hm
	icon_state = "545x39hm"

/obj/item/ammo_box/stalker/b9x18/hm
	desc = "Full Metal Jacket handgun cartridge of the Warsaw Pact, It has a good stopping effect, but is ineffective against armored targets (9x18mm). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/c9x18/hm
	icon_state = "9x18hm"

/obj/item/ammo_box/stalker/b12x70/hm
	desc = "12 gauge cartridge with 6mm shot, high tissue damage if penetration occurs (12x70mm). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/shotgun/c12x70/hm
	icon_state = "12x70hm"

/obj/item/ammo_box/stalker/b9x19/hm
	desc = "Full Metal Jacket handgun cartridge commonly used by NATO, It has a good stopping effect, but is ineffective against armored targets (9x18mm). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/c9x19/hm
	icon_state = "9x19hm"

/obj/item/ammo_box/stalker/b55645/hm
	desc = "Standard issue intermediate cartridge of NATO, Full Metal Jacket(5.56x45mm M855). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/c556x45/hm
	icon_state = "556x45hm"

/obj/item/ammo_box/stalker/b939/hm
	desc = "Full Metal Jacket subsonic cartridge used by USSR Special Forces,  to 530 metres with high tissue damage (9x39mm SP-5). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/sp9x39/hm
	icon_state = "9x39hm"

/obj/item/ammo_box/stalker/bacp45/hm
	desc = "Outdated Full Metal Jacket handgun cartridge from the USA with high tissue damage but lacks armor penetration, also known as .45 ACP (11.43×23mm). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/acp45/hm
	icon_state = "45_ACPhm"

/obj/item/ammo_box/stalker/bmag44/hm
	desc = "Full Metal Jacket handgun cartridge from Remington, also known as .44 Magnum or 'the most powerful handgun cartige in the world'  (10.9x33mmR). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/mag44/hm
	icon_state = "44_Maghm"

/obj/item/ammo_box/stalker/b762x25/hm
	desc = "Outdated handgun cartridge from the USSR, cheap but hard to handle (7.62x25mm Tokarev P-41). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/c762x25/hm
	icon_state = "762x25hm"

/obj/item/ammo_box/stalker/b762x51/hm
	desc = "Battle Rifle cartidge used by NATO, high recoil makes full auto not practical (7.62x51mm M80). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/c762x51/hm
	icon_state = "762x51hm"

/obj/item/ammo_box/stalker/b762x54r/hm
	desc = "Rimmed Rifle cartidge used by by Russia from the late 19th century, this is the 7N1 variantv (7.62x51mmR). The box has a strap of duct-tape wrapped around it."
	ammo_type = /obj/item/ammo_casing/c762x51/hm
	icon_state = "762x51hm"