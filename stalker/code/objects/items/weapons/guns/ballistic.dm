...
/obj/item/gun/ballistic/automatic/pistol/sip  // Sig-Sauer
	name = "SIG-Sauer P220"
	desc = "Модель, разработанная ещё в 1975 году, но до сих пор популярная во всём мире. Магазин недостаточно ёмкий, зато механизм надёжен как швейцарские часы; вторым плюсом является использование мощного кольтовского патрона .45 калибра."
...
/obj/item/gun/ballistic/automatic/pistol/cora  // Colt1911A
	name = "Colt M1911"
	desc = "Классический автоматический «кольт», с честью прошедший все вооружённые конфликты XX века и уверенно вошедший в новое столетие. Невысокая ёмкость магазина в определённой степени компенсируется использованием мощного патрона."
...
/obj/item/gun/ballistic/automatic/pistol/marta  // Beretta92FS
	name = "Beretta 92FS"
	desc = "Состоит на вооружении вооружённых сил и полиции США, многих военизированных и правохранительных формирований во всём мире. Столь же популярна и у представителей преступного мира благодаря мощному патрону и большой ёмкости магазина."
...
/obj/item/gun/ballistic/automatic/mp5  // MP5
	name = "MP-5"
	desc = "Одно из самых лучших в классе пистолетов-пулемётов оружие. В течении последних десятилетий XX века был принят на вооружение спецподразделений армии и полиции во многих странах мира. С началом его постепенной замены более современными моделями стал часто появляться на чёрном рынке, откуда массово попал и в Зону."
...
/obj/item/gun/ballistic/automatic/il86  // ИЛ86
	name = "L85"
	desc = "После того, как эта винтовка была заменена армией Великобритании на немецкую ГП37, она в большом количестве всплыла на чёрном рынке, а затем и в Зоне. Главным достоинством ИЛ86 являются штатный 4-кратный прицел и высокая точность первого выстрела. При стрельбе очередями точность боя резко падает, а надёжность основных механизмов винтовки недостаточно высока. Эффективна при стрельбе короткими очередями и одиночными."
...
/obj/item/gun/ballistic/automatic/gp37  // GP37
	name = "GP37"
	desc = "Штурмовая винтовка нового поколения, производимая в Германии в малых партиях для отрядов специального назначения. Оборудована встроенным прицелом для боя на средних дистанциях, крайне надежна и эффективна в любых условиях. Выбор многих мастеров группировок вроде Свободы и Наемников."
...
/obj/item/gun/ballistic/automatic/val  // Вал
	name = "AS Val"
	desc = "Создан на базе бесшумной снайперской винтовки 'Винторез', от которой отличается складным прикладом и укороченным стволом. Изначально предназначался для применения спецподразделениями в условиях атаки, требующей бесшумной и беспламенной стрельбы."
...
/obj/item/gun/ballistic/automatic/vintorez  // ВСС Винторез
	name = "VSS Vintorez"
	desc = "Винтовка специальная снайперская 'Винторез'. Предназначена для бесшумной и беспламенной снайперской стрельбы и снабжена интегрированным глушителем. С расстояния 400 метров пробивает большинство бронежилетов. Очень ценимое сталкерами любого уровня оружие."
